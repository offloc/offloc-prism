...
namespace Offloc\Prism\Domain\Model\Service;
...
class ServiceFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $keyGenerator = $this->getMock('Offloc\Prism\Domain\Service\IdentityGeneratorServiceInterface');
        $keyGenerator
            ->expects($this->once())
            ->method('generateIdentity')
            ->will($this->returnValue('some key'));

        $secretGenerator = $this->getMock('Offloc\Prism\Domain\Service\SecretGeneratorServiceInterface');
        $secretGenerator
            ->expects($this->once())
